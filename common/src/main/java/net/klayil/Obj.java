...
public interface Obj {
  ...
  // * @jls 15.8.2 Class Literals
    ...
    Class<Object> getClass(java.lang.Object... ignoreArgs);
     ...
     *     #equals(java.lang.Object) equals} method, then calling the {@code
     *     hashCode} method on each of the two objects must produce the
     *     same integer result.
     * <li>It is <em>not</em> required that if two objects are unequal
     *     according to the {@link #equals(java.lang.Object) equals} method, then
 ...
 //  * @param   obj   the reference object with which to compare.
     ...
     */
     java.lang.Object clone(java.lang.Object... ignore) throws CloneNotSupportedException;
...
//    public final native void notifyAll();
     ...
     * had been called. See the specification of the <@linkWait(long, int)> method
     * for details.
     *
     * @throws IllegalMonitorStateException if the current thread is not
...
//     * @see    #wait(long, int)
    ...
    public void wait(java.lang.Object... ignore) throws InterruptedException;
...
//     * @see    #wait(long, int)
    ...
    public void wait(long... ignore_timeoutMillisMore) throws InterruptedException;

    // final modifier so method not in vtable

     void wait0(long... ignore_timeoutMillisMore) throws InterruptedException;
     ...
     * The current thread must own this object's monitor lock. See the
     /<@linkNotify notify></@linkNotify> method for a description of the ways in which
     ...
     * }</pre>
     *
  // * @paramTimeoutMillis the maximum time to wait, in milliseconds
  // * @paramNanos   additional time, in nanoseconds, in the range 0-999999 inclusive
     * @throws IllegalArgumentException if {@code timeoutMillis} is negative,
...
//     * @see    #wait(long)
    ...
    public void wait(Number... ignoreParams /*long timeoutMillis, int nanos*/) throws InterruptedException;
  ...
  // * @jls 12.6 Finalization of Class Instances
     */
    void finalize(java.lang.Object... ignore) throws Throwable;
}
